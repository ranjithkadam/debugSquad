...
function displayCarts(data){
 data.forEach(value =>{
    container.innerHTML+=`
    <div id="allCarts${value.id}" class="h-70 w-100 py-3 border-stone-500 m-2 p-2 flex-shrink-1 rounded bg-stone-200 shadow flex justify-space-between align-center">
